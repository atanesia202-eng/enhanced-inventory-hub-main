...
export const MAP_COLLECTIBLES: Collectible[] = [
  ...
  { id: collectibleId++, pos: { x: 500, y: 410 }, width: 24, height: 24, type: 'star', value: 0, collected: false },
  ...
  { id: collectibleId++, pos: { x: 750, y: 90 }, width: 24, height: 24, type: 'star', value: 0, collected: false },
  ...
  { id: collectibleId++, pos: { x: 2800, y: 170 }, width: 24, height: 24, type: 'star', value: 0, collected: false },
  ...
  { id: collectibleId++, pos: { x: 3500, y: 300 }, width: 24, height: 24, type: 'diamond', value: 1, collected: false },
];
